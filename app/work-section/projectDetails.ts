...
export const devProjects = [
  {
    id: 0,
    name: 'Odunsi',
    description: 'Portfolio website for Michael Odunsi.',
  ...
  },
  {
    id: 2,
    name: 'Synthetix',
    description: 'Built specifically for an AI startup.',
  ...
  },
  {
    id: 3,
    name: 'Propellent',
    description: 'A website built for a software startup and small business.',
    technologies: ['React', 'Tailwind CSS', 'Framer Motion'],
  ...
  },
  {
    id: 4,
    name: 'Flixify',
    description: 'Flixify lets you seamlessly explore movies and TV series.',
